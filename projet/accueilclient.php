...
<body> 
    ...
    <div class="product-container">
        <div class="product-carousel">
            <img src="../projet/images/skip1.png" class="carousel-image">
            <img src="../projet/images/skip4.webp" class="carousel-image">
            <img src="../projet/images/skip3.png" class="carousel-image">
        </div>
    </div>
    <script>
        var index = 0;
